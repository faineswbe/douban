<template>       <!-- 评分星星的组件 -->
	<div class="star" :class="starType">    <!-- starType是星星的类型，不同的地方显示的星星大小不一样 -->
		<span v-for="(item,index) in itemClass" :key="index" class="star-item" :class="item"></span>    <!-- itemClass是数组，有on,half,off，全星，半星，无 -->
	</div>
</template>
...
.star{
	...
	.star-24 .half {
		background: url('../../../assets/star/half.png') no-repeat;
		background-size: 0.25rem 0.25rem;
	}
	.star-24 .off {
